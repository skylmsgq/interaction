...
def send_msg(tofakeids):
    for tofakeid in tofakeids:
        paras2 = {'type':'1','content':'空气中颗粒物浓度已超标！','error':'false','imgcode':'','tofakeid':tofakeid,'token':token,'ajax':'1'}# content为你推送的信息，tofakeid为用户的唯一标示id，可在html代码里找到
...
send_msg(["51375040","1988092085","2376661902"])
